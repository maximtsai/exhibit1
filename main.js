...
function handleViewShift() {
    ...
    gameObjects.exhibCntr.offsetAccX += .0012 * a - .02 * gameObjects.exhibCntr.offsetAccX, gameObjects.exhibCntr.offsetAccY += .0012 * b - .02 * gameObjects.exhibCntr.offsetAccY, gameObjects.exhibCntr.offsetX = .9 * gameObjects.exhibCntr.offsetX + gameObjects.exhibCntr.offsetAccX, gameObjects.exhibCntr.offsetY = .9 * gameObjects.exhibCntr.offsetY + gameObjects.exhibCntr.offsetAccY, gameObjects.exhibCntr.x = gameObjects.exhibCntr.swayX + gameObjects.exhibCntr.offsetX, gameObjects.exhibCntr.y = gameObjects.exhibCntr.swayY + gameObjects.exhibCntr.offsetY + 4, gameObjects.shadowCntr.x = 1.01 * gameObjects.exhibCntr.x, gameObjects.shadowCntr.y = 1.01 * gameObjects.exhibCntr.y, gameObjects.portraitCntr.x = gameObjects.exhibCntr.x, gameObjects.portraitCntr.y = gameObjects.exhibCntr.y, gameObjects.btnCntr.x = gameObjects.exhibCntr.x, gameObjects.btnCntr.y = gameObjects.exhibCntr.y, gameObjects.mainDarkCntr.x = gameObjects.exhibCntr.x, gameObjects.mainDarkCntr.y = gameObjects.exhibCntr.y, gameObjects.hueCntr.x = -5 * gameObjects.exhibCntr.x, gameObjects.hueCntr.y = -5 * gameObjects.exhibCntr.y
}
